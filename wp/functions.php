...
if ( ! function_exists( 'company_setup' ) ) :
	...
	function company_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'company' ),
		) );
...
/**
 * 管理画面のフッター部分に表示される「WordPress のご利用ありがとうございます。」という表記を消す
 */
...
add_filter('wp_pagenavi_class_page', 'my_filter_wp_pagenavi_class_page');
function my_filter_wp_pagenavi_class_page($class_name) {
return 'page-numbers';
}

add_filter('wp_pagenavi_class_nextpostslink', 'my_filter_wp_pagenavi_class_nextpostslink');
function my_filter_wp_pagenavi_class_nextpostslink($class_name) {
